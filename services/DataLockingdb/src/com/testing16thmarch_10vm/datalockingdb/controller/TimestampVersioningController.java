...
import com.testing16thmarch_10vm.datalockingdb.service.TimestampVersioningService;
 ...
 */
@RestController("DataLockingdb.TimestampVersioningController")
@Api(value = "TimestampVersioningController", description = "Exposes APIs to work with TimestampVersioning resource.")
@RequestMapping("/DataLockingdb/TimestampVersioning")
public class TimestampVersioningController {
    ...
    @Autowired
	@Qualifier("DataLockingdb.TimestampVersioningService")
