...
/**
 * Specifies methods used to obtain and modify PersonFruits related information
 * which is stored in the database.
 */
@Repository("WMSTUDIO.PersonFruitsDao")
public class PersonFruitsDao extends WMGenericDaoImpl<PersonFruits, PersonFruitsId> {
