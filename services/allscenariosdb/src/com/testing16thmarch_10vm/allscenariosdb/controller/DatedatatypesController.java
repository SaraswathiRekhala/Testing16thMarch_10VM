...
import com.testing16thmarch_10vm.allscenariosdb.service.DatedatatypesService;
 ...
 * @see Datedatatypes
 */
@RestController("allscenariosdb.DatedatatypesController")
@Api(value = "DatedatatypesController", description = "Exposes APIs to work with Datedatatypes resource.")
@RequestMapping("/allscenariosdb/Datedatatypes")
public class DatedatatypesController {
    ...
    @Autowired
	@Qualifier("allscenariosdb.DatedatatypesService")
    ...
    public Datedatatypes editDatedatatypes(@PathVariable("id") Integer id, @RequestBody Datedatatypes datedatatypes) {
        LOGGER.debug("Editing Datedatatypes with id: {}" , datedatatypes.getPkid());

        datedatatypes.setPkid(id);
