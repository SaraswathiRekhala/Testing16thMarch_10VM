...
import com.testing16thmarch_10vm.allscenariosdb.service.Many2oneCService;
 ...
 * @see Many2oneC
 */
@RestController("allscenariosdb.Many2oneCController")
@Api(value = "Many2oneCController", description = "Exposes APIs to work with Many2oneC resource.")
@RequestMapping("/allscenariosdb/Many2oneC")
public class Many2oneCController {
    ...
    public Many2oneC editMany2oneC(@PathVariable("id") Integer id, @RequestBody Many2oneC many2oneC) {
        LOGGER.debug("Editing Many2oneC with id: {}" , many2oneC.getChildId());

        many2oneC.setChildId(id);
