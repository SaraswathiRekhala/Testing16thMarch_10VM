...
import com.testing16thmarch_10vm.allscenariosdb.service.One2manyPService;
...
public class One2manyPController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2manyP getOne2manyP(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2manyP editOne2manyP(@PathVariable("id") Short id, @RequestBody One2manyP one2manyP) {
        LOGGER.debug("Editing One2manyP with id: {}" , one2manyP.getShortId());

        one2manyP.setShortId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2manyP(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Many2oneC> findAssociatedMany2oneCs(@PathVariable("id") Short id, Pageable pageable) {
