...
/**
 * Specifies methods used to obtain and modify Blobtable related information
 * which is stored in the database.
 */
@Repository("allscenariosdb.BlobtableDao")
public class BlobtableDao extends WMGenericDaoImpl<Blobtable, Integer> {
