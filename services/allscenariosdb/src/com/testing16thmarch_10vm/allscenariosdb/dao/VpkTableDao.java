...
/**
 * Specifies methods used to obtain and modify VpkTable related information
 * which is stored in the database.
 */
@Repository("allscenariosdb.VpkTableDao")
public class VpkTableDao extends WMGenericDaoImpl<VpkTable, Integer> {
