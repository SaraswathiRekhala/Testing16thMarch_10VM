 ...
 * @see Many2oneC
 */
@Service("allscenariosdb.Many2oneCService")
@Validated
public class Many2oneCServiceImpl implements Many2oneCService {
    ...
    @Autowired
    @Qualifier("allscenariosdb.Many2oneCDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service allscenariosdb for table Many2oneC to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service allscenariosdb for table Many2oneC to {} format", options.getExportType());
