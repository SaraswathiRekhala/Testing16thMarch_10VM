...
public interface One2manyPService {
     ...
     */
    One2manyP getById(Short one2manypId);
     ...
     * @return One2manyP associated with the given one2manypId.
     */
    One2manyP findById(Short one2manypId);
     ...
     */
    List<One2manyP> findByMultipleIds(List<Short> one2manypIds, boolean orderedReturn);
     ...
     */
    One2manyP delete(Short one2manypId);
     ...
     * @see Page
     */
    Page<Many2oneC> findAssociatedMany2oneCs(Short shortId, Pageable pageable);
