...
package com.testing16thmarch_10vm.cascadedb.dao;
...
/**
 * Specifies methods used to obtain and modify CompositeLocking related information
 * which is stored in the database.
 */
@Repository("cascadedb.CompositeLockingDao")
public class CompositeLockingDao extends WMGenericDaoImpl<CompositeLocking, CompositeLockingId> {
    ...
    @Autowired
    @Qualifier("cascadedbWMQLTypeHelper")
