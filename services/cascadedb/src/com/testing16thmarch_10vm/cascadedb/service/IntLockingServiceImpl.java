 ...
 * @see IntLocking
 */
@Service("cascadedb.IntLockingService")
@Validated
public class IntLockingServiceImpl implements IntLockingService {
    ...
    @Autowired
    @Qualifier("cascadedb.IntLockingDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service cascadedb for table IntLocking to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service cascadedb for table IntLocking to {} format", options.getExportType());
