...
public class WMCustomAuth implements WMCustomAuthenticationManager {

 private static final Logger logger=LoggerFactory.getLogger(WMCustomAuth.class);
 ...
 public WMUser authenticate(AuthRequestContext authRequestContext) throws AuthenticationException {
        ...
        if (username.equals("admin") && authRequestContext.getPassword().equals("admin")) {
